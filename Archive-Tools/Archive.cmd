...
:COPY_FILE
	IF NOT DEFINED XCOPY_DIRECTORY (SET /P XCOPY_DIRECTORY="XCOPY_DIRECTORY(E:\%USERDOMAIN%)=")
	IF NOT DEFINED XCOPY_DIRECTORY (SET XCOPY_DIRECTORY=E:\%USERDOMAIN%)
	XCOPY %ARCHIVE_DIR%\%yyyy%%mm%\%DOWNLOAD_FILENAME%.* %XCOPY_DIRECTORY%\%yyyy%%mm%\ /Y /H /S /E /F /K
	EXPLORER %XCOPY_DIRECTORY%\%yyyy%%mm%\
