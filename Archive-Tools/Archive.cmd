...
REM SET DL_DIR=%ARCHIVE_DIR%\DL_%yyyy%%mm%
REM x=[0 | 1 | 3 | 5 | 7 | 9 ] 
...
IF NOT DEFINED DL_DIR SET DL_DIR=%ARCHIVE_DIR%\DL_%yyyy%%mm%
...
:COPY_FILE
	...
	SET ARCHIVE_STORE_DIR=%STORE_DIR%\%yyyy%%mm%
	MD %ARCHIVE_STORE_DIR%
	MOVE %ARCHIVE_DIR%\%yyyy%%mm%\*.7z %ARCHIVE_STORE_DIR%\
	MOVE %ARCHIVE_DIR%\%yyyy%%mm%\*.7z.??? %ARCHIVE_STORE_DIR%\
