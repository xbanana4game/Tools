...
REM ---------- Re_Archive.cmd ----------
REM SET SET RA_OUTPUT_DIR=%DESKTOP_DIR%
REM SET TARGET_DIR=%DOWNLOADS_DIR%
REM SET RA_STORE_DIR=%DESKTOP_DIR%\store
REM SET RA_STORE_DIR=%DRIVE_LETTER_CMD%\Store
...
REM IF NOT DEFINED RA_STORE_DIR SET RA_STORE_DIR=%DESKTOP_DIR%\Store
REM IF NOT DEFINED RA_STORE_DIR SET RA_STORE_DIR=%DRIVE_LETTER_CMD%\Store
...
CD /D %TARGET_DIR%
FOR /R %TARGET_DIR% %%j IN ("%TARGET_FILE_EXP%.zip" "%TARGET_FILE_EXP%.7z") DO (
	ECHO %%j
