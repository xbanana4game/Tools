...
:COPY_VIDEOS
	...
	IF EXIST %VIDEOS_STORE_DIR%\%VIDEO_STORE_NAME%_%yyyy%-%mm%-%dd%.m3u8 (
		TYPE %VIDEOS_STORE_DIR%\%VIDEO_STORE_NAME%_%yyyy%-%mm%-%dd%.m3u8>>%CONFIG_DIR%\yt-dlp-history\VD_%yyyy%%mm%.m3u8
		MOVE %VIDEOS_STORE_DIR%\%VIDEO_STORE_NAME%_%yyyy%-%mm%-%dd%.m3u8 %VIDEOS_STORE_DIR%\%VIDEO_STORE_NAME%.m3u8
	)
