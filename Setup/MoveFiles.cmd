...
:MOVE_VIDEOS
	...
	SET MP3TAG_M3U8_FILE=%VIDEOS_STORE_DIR%\%TARGET_DIR%\%TARGET_DIR%_%yyyy%-%mm%-%dd%.m3u8
	SET STORE_M3U8_FILE=%VIDEOS_STORE_DIR%\%TARGET_DIR%\%TARGET_DIR%_%yyyy%-%mm%-%dd%_%hh%%mn%%ss%.m3u8
...
:COPY_VIDEOS
	...
	SET MP3TAG_M3U8_FILE=%VIDEOS_STORE_DIR%\%VIDEO_STORE_NAME%_%yyyy%-%mm%-%dd%.m3u8
	IF EXIST %VIDEOS_STORE_DIR% Mp3tag.exe /fp:"%VIDEOS_STORE_DIR%"
	IF EXIST %MP3TAG_M3U8_FILE% (
		TYPE %MP3TAG_M3U8_FILE%>>%CONFIG_DIR%\yt-dlp-history\VD_%yyyy%%mm%.m3u8
		MOVE %MP3TAG_M3U8_FILE% %VIDEOS_STORE_DIR%\%VIDEO_STORE_NAME%.m3u8
	)
