...
REM SET /P ARCHIVE_SONGS_FILES="動画をアーカイブしますか? 1/0 -> "
REM IF ""=="%ARCHIVE_SONGS_FILES%" SET ARCHIVE_SONGS_FILES=0
...
REM IF 1 EQU %ARCHIVE_SONGS_FILES% (CALL :F_OSU_ARCHIVE_FILES)
