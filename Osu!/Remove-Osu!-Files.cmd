...
REM SET /P DELETE_SB_FILES="Remove StoryBoard? 1/0 -> "
REM IF ""=="%DELETE_SB_FILES%" SET DELETE_SB_FILES=0

REM SET /P DELETE_VIDEOS_FILES="Remove Videos? 1/0 -> "
REM IF ""=="%DELETE_VIDEOS_FILES%" SET DELETE_VIDEOS_FILES=0

REM SET /P DELETE_SOUNDS_FILES="Remove Sounds? 1/0 -> "
REM IF ""=="%DELETE_SOUNDS_FILES%" SET DELETE_SOUNDS_FILES=0

REM SET /P DELETE_PICTURES_FILES="Remove Images? 1/0 -> "
REM IF ""=="%DELETE_PICTURES_FILES%" SET DELETE_PICTURES_FILES=0

SET /P ARCHIVE_SONGS_FILES="Archive Files? 1/0 -> "
IF ""=="%ARCHIVE_SONGS_FILES%" SET ARCHIVE_SONGS_FILES=0


REM IF 1 EQU %DELETE_SB_FILES% (CALL :F_OSU_DELETE_SB)
REM IF 1 EQU %DELETE_VIDEOS_FILES% (CALL :F_OSU_DELETE_VIDEOS)
REM IF 1 EQU %DELETE_SOUNDS_FILES% (CALL :F_OSU_DELETE_SOUNDS)
REM IF 1 EQU %DELETE_PICTURES_FILES% (CALL :F_OSU_DELETE_PICTURES)
IF 1 EQU %ARCHIVE_SONGS_FILES% (CALL :F_OSU_ARCHIVE_FILES)
REM EXPLORER %OSU_DIR%\Logs
EXIT
