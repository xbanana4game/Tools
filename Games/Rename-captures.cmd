...
ECHO ======================================================================
ECHO Rename GAME_DIR\GAME_NAME - YYYYMMDD.mp4
IF NOT DEFINED CAPTURE_NO (SET /P CAPTURE_NO="SET CAPTURE_NO If skip input custom game : ")
...
REM IF NOT DEFINED GAME_DIR (SET /P GAME_DIR="SET GAME_DIR ALBUM : ")
IF NOT DEFINED GAME_DIR (SET GAME_DIR=%GAME_NAME%)

MD "%CAPTURES_DIR%\%GAME_DIR%\videos"
FOR %%i IN ("%CAPTURES_DIR%\*.mp4") DO (
	ECHO RENAME "%%i" "%GAME_NAME% - %%~nxi"
	RENAME "%%i" "%GAME_NAME% - %%~nxi"
	MOVE "%CAPTURES_DIR%\%GAME_NAME% - %%~nxi" "%CAPTURES_DIR%\%GAME_DIR%\videos\"
)
