...
EXPLORER %KILLINGFLOOR_DIR%\Cache
...
:TREE_KF_SERVER
	...
	REM TREE /F /A %SERVER_NAME% >%SERVER_NAME%\%SERVER_NAME%.txt
	DIR /S /B %KILLINGFLOOR_DIR%\KF-SERVER >%SERVER_NAME%\%SERVER_NAME%.txt
	REM NOTEPAD %SERVER_NAME%\%SERVER_NAME%.txt
	EXIT /B
