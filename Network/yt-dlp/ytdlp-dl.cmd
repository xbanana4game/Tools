...
ECHO CALL ytdlp-dl.cmd %%BATCH_LIST_DIR%%\%CONFIG_FILENAME% %%BATCH_LIST_DIR%%\%YTDLP_DLURL_LIST_NAME%.%END_FILE_EXT%>>%BATCH_FILE%
ECHO REM yt-dlp.exe --config-location %%BATCH_LIST_DIR%%\%CONFIG_FILENAME% %%YTDLP_BATCH_OPT%% %%YTDLP_OPT%% -a %%BATCH_LIST_DIR%%\%YTDLP_DLURL_LIST_NAME%.%END_FILE_EXT%>>%BATCH_FILE%
