...
IF NOT DEFINED BATCH_FILE SET BATCH_FILE=%YTDLP_CONF_DIR%\__ytdlp_%yyyy%%mm%%dd%.cmd
...
IF %SKIP_FLG%==1 (
	...
	strip_url.py %DLURL_LIST% %YTDLP_DLURL_LIST%
)
...
IF "%BATCH_ONLY%"=="1" (
	SET YTDLP_CONFIG_FILE_BATCH=%DLURL_LIST%_batch.conf
...
IF NOT DEFINED DLURL_RESERVED_FILE (
	...
	IF EXIST %YTDLP_DLURL_LIST% DEL %YTDLP_DLURL_LIST%
)
