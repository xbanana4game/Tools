...
:SET_INPUT_MODE
FINDSTR /C:"INPUT_MODE" %YTDLP_PROFILE_FILE%
IF ERRORLEVEL 1 (
	REM PASS
) ELSE (
	SET MODE=INPUT
	GOTO :SET_INPUT_MODE_END
)
FOR %%i in (%YTDLP_DL_LIST_FILE_EXP%) DO (
	SET INPUT_DL_LIST_FILE=%%i
)
CHOICE /C 123456 /M "1:INPUT 2:FILE 3:BATCH 4:PLAYLIST 5:FORMAT 6:UPDATE"
IF %ERRORLEVEL% EQU 1 (
	SET MODE=INPUT
...
:SET_RESOLUTION
FINDSTR /C:"RESOLUTION" %YTDLP_PROFILE_FILE%
IF ERRORLEVEL 1 (
	REM PASS
) ELSE (
