...
REM SET DLURL_LIST_NAME=_%yyyy%-%mm%-%dd%_%~n1_T%hh%%mn%%ss%
...
IF NOT DEFINED DLURL_LIST_NAME SET DLURL_LIST_NAME=_%yyyy%-%mm%-%dd%_%~n1_T%hh%%mn%%ss%
...
FINDSTR /C:"#SKIP_MODE_ON" %YTDLP_CONFIG_FILE_DEFAULT%
IF ERRORLEVEL 1 (
	REM PASS
) ELSE (
	SET SKIP_FLG=1
...
SET BATCH_LOCK_FILE=%DESKTOP_DIR%\%~n1.lock
