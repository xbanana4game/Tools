...
ECHO REM %YTDLP_PROFILE%_%yyyy%%mm%%dd%-%hh%%mn%%ss%>>%BATCH_FILE%
...
ECHO REM yt-dlp.exe --config-location %DLURL_LIST_NAME%_batch.dlp %YTDLP_RESOLUTION_OPT% -a %DLURL_LIST_NAME%.%END_FILE_EXT%>>%BATCH_FILE%
ECHO;>>%BATCH_FILE%
