...
CD /D %VIDEOS_DIR%
MOVE %DLURL_LIST% %DLURL_LIST%.%END_FILE_EXT%
...
REM RUN
yt-dlp.exe %YTDLP_CONF_OPT% %YTDLP_RESOLUTION_OPT% -a %DLURL_LIST%.%END_FILE_EXT%
IF %ERRORLEVEL% EQU 0 (
	GOTO :DL_END
)
EXIT /B
...
ECHO CALL %TOOLS_DIR%\Network\ytdlp-dl.cmd %YTDLP_CONFIG_FILE% %DLURL_LIST%.%END_FILE_EXT%>>%BATCH_FILE%
