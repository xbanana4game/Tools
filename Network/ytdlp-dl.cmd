...
IF NOT DEFINED YTDLP_CONFIG_FILE SET YTDLP_CONFIG_FILE=%VIDEO_OUTPUT_DIR%\yt-dlp_%yyyy%%mm%%dd%-%hh%%mn%%ss%.conf
...
:SET_SKIP_MODE
CHOICE /C 01 /T 0 /D 1 /M "SKIP MODE "
IF %ERRORLEVEL% EQU 1 (
	ECHO SKIP MODE OFF
	SET SKIP_FLG=0
...
:SET_INPUT_MODE
CHOICE /C 123 /T 10 /D 1 /M "1:INPUT 2:FILE 3:csv.txt "
IF %ERRORLEVEL% EQU 1 (
	SET MODE=INPUT
) ELSE IF %ERRORLEVEL% EQU 2 (
	SET MODE=FILE
...
:DL_END
IF EXIST %DLURL_LIST% MOVE %DLURL_LIST% %DLURL_LIST%.log
